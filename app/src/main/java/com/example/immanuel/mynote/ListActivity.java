...
public class ListActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list);// SET THE VIEW / XML FILE FOR THIS ACTIVITY

        /*listBottomBar = (ImageButton) findViewById(R.id.listBottomBar);
        listBottomBar.setBackgroundColor(Color.argb(255,211,47,47));
        listBottomText = (TextView) findViewById(R.id.listBottomTitle);
        listBottomText.setBackgroundColor(Color.argb(255,211,47,47));
        listBottomText.setTextColor(Color.WHITE);*/
